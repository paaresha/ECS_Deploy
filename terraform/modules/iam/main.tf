...
resource "aws_iam_openid_connect_provider" "github" {
  for_each = var.enable_github_oidc ? toset(["github"]) : toset([])
...
resource "aws_iam_role" "github_actions" {
  ...
  assume_role_policy = jsonencode({
    ...
    Statement = [{
      Effect = "Allow"
      Principal = {
        Federated = aws_iam_openid_connect_provider.github["github"].arn
      }
...
resource "aws_iam_role_policy" "github_actions_deploy" {
  ...
  role = aws_iam_role.github_actions["github"].id
